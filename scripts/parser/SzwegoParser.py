        ...
        while True:
            ...
            for item in items:
                ...
                if page_idx == 1 and not all_rows and page_saved == 0:
                    item_date_debug = get_item_date(item, session, args.album_id, headers)
                ...
                if not item_date: item_date = _parse_date_from_text(description)
            ...
            print(f"Page {page_idx}: saved {page_saved}. Total: {len(all_rows)}")
