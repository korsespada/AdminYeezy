...
import { CheckSquare, Filter, FolderTree, Gem, GitMerge, Images, LayoutGrid, Plus, RotateCcw, Square, Trash2, Upload, X } from 'lucide-react'
        ...
        <div className="mx-auto max-w-[1600px]">
          <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex w-full flex-wrap gap-2 sm:w-auto">
              ...
              <Button asChild type="button" variant="outline" className="h-11 border-amber-700/60 bg-amber-950/30 text-amber-200"><Link href="/admin/chromoff/david-rings"><GitMerge className="h-4 w-4" />Дубли колец</Link></Button>
