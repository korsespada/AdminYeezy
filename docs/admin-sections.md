...
| `/admin/chromoff` | Каталог Chromoff: общий формат карточек и bulk actions основного каталога, фильтры по товару и Chromoff-статусам, отдельные поля публикации и SEO | Rails Chromoff API + Rails catalog lookups |
