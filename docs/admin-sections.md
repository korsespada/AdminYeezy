...
| `/admin/measurement-templates` | Библиотека скриншотов и структурированных таблиц замеров для назначения в карточках выгрузки | `yeezy_scraping.measurement_templates` |
