...
общий `Product.primary_supplier`; для одного из разрешённых source ID карточка
становится автосинхронизируемой, для другого поставщика - ручной.
