...
При изменении базовой цены через `PATCH /api/v1/admin/products/:id` Rails синхронизирует цену всех вариантов с указанным размером, включая исторически импортированные. Вариант без размера сохраняет отдельную цену.
